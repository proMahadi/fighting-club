  ...
  return (
    <section className="bg-black">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="bg-story1Bg bg-no-repeat bg-center bg-cover w-full h-[390px] md:h-[531px] xl:h-[631px] flex justify-center items-center p-6">
        ...
        <div className="bg-story2Bg bg-no-repeat bg-center bg-cover w-full h-[390px] md:h-[531px] xl:h-[631px] flex justify-center items-center p-6">
